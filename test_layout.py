...
lbl=Label(*con.grid.CellPair(0, 0), text='Hello world!', bcol=Vector(0.5, 0.5, 0, 0.5))
con.children.append(lbl)
lbl=Label(*con.grid.CellPair(1, 0), text='I\'m fine today', align=TALIGN.LEFT, bcol=Vector(0.5, 0, 0, 0.5))
con.children.append(lbl)
lbl=Label(*con.grid.CellPair(1, 1), text='How are you?', align=TALIGN.FILLX, bcol=Vector(0, 0, 0.5, 0.5))
con.children.append(lbl)
lbl=Label(*con.grid.CellPair(1, 2), text='I\'m great thanks!', align=TALIGN.FILLY, bcol=Vector(0, 0.5, 0, 0.5))
con.children.append(lbl)
